...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/JGDFd8eEDr)
...
```sh
npx nx serve dragonsjs.com
```

To create a production bundle:

```sh
npx nx build dragonsjs.com
```

To see all available targets to run for a project, run:

```sh
npx nx show project dragonsjs.com
```
